...
m_magicVariables(vector<shared_ptr<MagicVariableDeclaration const>>{
	...
	make_shared<MagicVariableDeclaration>("static_assert", make_shared<FunctionType>(strings{"bool"}, strings{}, FunctionType::Kind::StaticAssert, false, StateMutability::Pure)),
	...
	make_shared<MagicVariableDeclaration>("static_require", make_shared<FunctionType>(strings{ "bool" }, strings{}, FunctionType::Kind::StaticRequire, false, StateMutability::Pure)),
	make_shared<MagicVariableDeclaration>("static_require", make_shared<FunctionType>(strings{ "bool", "string memory" }, strings{}, FunctionType::Kind::StaticRequire, false, StateMutability::Pure)),
